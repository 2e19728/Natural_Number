...
number-theoretic-transform engine. One thread, no external dependencies.

> **This tree is the AVX-512 variant.** The NTT's merged radix-4 passes run on IFMA zmm
> kernels (`src/mul_ntt_avx512.s`) instead of the scalar ones, with the fixed distance-2 pair
