...
//                        asmSqr              -> mul_basecase.s        (sqr_basecase)
...
//   * squaring: the base case now has its own kernel (mul_basecase.s's sqr_basecase, which
...
//     asmNttMul with nw_a == nw_b (the kernel reads all four butterfly inputs of a group
