...
// words followed by the two carry words (asmCRT's contract), trimmed of trailing zero
// limbs.  asmCRT always merges from index 0, so a nonzero offset is served by gathering
