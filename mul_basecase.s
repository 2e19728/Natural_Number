# ============================ base-case kernels ============================
# Merged from the former mul_basecase_even.s and mul_basecase_odd.s.  Three entries:
#	mul_basecase_even(len2, len1, src2, src1, dst)  len2 even  (long x short)
#	mul_basecase_odd (len2, len1, src2, src1, dst)  len2 odd
#	sqr_basecase     (n, src, dst)                   square, no parity split
...
# ======================== sqr_basecase ========================
# sqr_basecase(n, src, dst)   rdi = n, rsi = src, rdx = dst,   n >= 3
...
# sqr_basecase instead of an even/odd pair.
	.globl	sqr_basecase
sqr_basecase:
	push	rbx
	push	rbp
